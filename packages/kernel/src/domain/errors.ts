...
export const ErrorCode = {
  ...
  NOT_FOUND_IDENTITY: 'NOT_FOUND_IDENTITY',
  NOT_FOUND_AVATAR: 'NOT_FOUND_AVATAR',
  NOT_FOUND_KNOWLEDGE_SOURCE: 'NOT_FOUND_KNOWLEDGE_SOURCE',
  NOT_FOUND_AUTORUN_CONFIG: 'NOT_FOUND_AUTORUN_CONFIG',
  NOT_FOUND_WALLET: 'NOT_FOUND_WALLET',
  NOT_FOUND_TEMPLATE: 'NOT_FOUND_TEMPLATE',
  NOT_FOUND_PROACTIVE_MESSAGE: 'NOT_FOUND_PROACTIVE_MESSAGE',
