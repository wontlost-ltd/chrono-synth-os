...
export const DEFAULT_FAMILY_CONFIG: FamilySystemConfig = Object.freeze({
  spouseSecurityWeight: 0.85,
  familyPressureCoefficient: 1.4,
  childEducationCostCurve: Object.freeze([50000, 55000, 60000, 65000, 70000, 75000, 80000, 90000, 100000, 110000]),
...
export function computeFamilyState(
  ...
  const wealthCover = Math.min(inputs.wealth / annualExpense, 5) / 5;
