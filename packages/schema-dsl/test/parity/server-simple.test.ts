...
describe('server-simple coverage', () => {
  it('covers v001-v087 simple migrations (raw 9 + PG-only v071/v072 deferred; v074=W2.1; v075=P0-E hash chain; v076=P1-F SOC2; v077=P1-N legal holds; v078=P1-M v2 break-glass jti; v079=P0-E v2 audit chain anchors; v080=P0-D #2 jwt signing keys; v081=GA §8 #1 audit anchor failures; v082=ADR-0047 distillation artifacts; v083=ADR-0047/0048 persona leases; v084=ADR-0047 response templates; v085=ADR-0047 persona rules; v086=BYOK llm provider credentials; v087=BYOK tenant llm settings)', () => {
