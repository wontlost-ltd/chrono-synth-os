...
describe('server-simple coverage', () => {
  it('covers v001-v077 simple migrations (raw 9 + PG-only v071/v072 deferred; v074=W2.1 onboarding; v075=P0-E audit hash chain; v076=P1-F SOC2 evidence; v077=P1-N legal holds)', () => {
